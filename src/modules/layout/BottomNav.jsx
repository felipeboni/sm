  ...
  return (
    ...
    >
      ...
      <Link className="px-10 py-2 text-primary-500" href="/wallet">
        {currentRoute === '/wallet' ? <AccountBalanceWalletIcon/> : <AccountBalanceWalletOutlinedIcon/>}

      </Link>
      <Link className="px-10 py-2 font-semibold" href="/profile">
        <div className="relative w-auto">
            <span className={`absolute right-0 p-3 -translate-x-1/2 -translate-y-1/2 border rounded-full top-1/2 left-1/2 ${currentRoute === '/profile' ? "border-primary-500" : "border-black/25"}`} />
